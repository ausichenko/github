...
interface GithubApi {
    ...
    @GET("search/commits")
    fun getCommits(@Query("q") searchQuery: String): Single<GitResponse<Commit>>

    @GET("search/issues")
    fun getIssues(@Query("q") searchQuery: String): Single<GitResponse<Issue>>
    ...
    @GET("search/users")
    fun getUsers(@Query("q") searchQuery: String): Single<GitResponse<User>>
}